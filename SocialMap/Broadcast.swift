...
struct Broadcast {
    ...
    init(content: String, addedByUser: String, photoPath: String, key:String = "", time: [String:String]) {
        self.key = key
    ...
    func toAny() -> Any {
        return ["content": content, "addedByUser": addedByUser, "photo": photoPath, "time": uploadTime]
    }
}
